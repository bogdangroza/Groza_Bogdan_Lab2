...
namespace Groza_Bogdan_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Groza_Bogdan_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Groza_Bogdan_Lab2Context context,
